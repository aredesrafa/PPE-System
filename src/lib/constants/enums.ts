...
export type StatusTipoEPIEnum = typeof StatusTipoEPI[keyof typeof StatusTipoEPI];
...
export type StatusEstoqueItemEnum = typeof StatusEstoqueItem[keyof typeof StatusEstoqueItem];
...
export type TipoMovimentacaoEnum = typeof TipoMovimentacao[keyof typeof TipoMovimentacao];
...
export type StatusEntregaEnum = typeof StatusEntrega[keyof typeof StatusEntrega];
...
export type StatusEntregaItemEnum = typeof StatusEntregaItem[keyof typeof StatusEntregaItem];
...
export type ConfiguracaoChaveEnum = typeof ConfiguracaoChave[keyof typeof ConfiguracaoChave];
 ...
 */
export function getHumanReadableStatusEntrega(status: StatusEntregaEnum): string {
 ...
 */
export function getHumanReadableStatusEntregaItem(status: StatusEntregaItemEnum): string {
