...
export const formClasses = {
  ...
  labelRequired: 'block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 after:content-["*"] after:text-red-500 after:ml-1',
  input: 'rounded-sm',
  inputError: 'rounded-sm border-red-500 focus:border-red-500 focus:ring-red-500',
