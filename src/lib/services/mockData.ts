...
function generateAdditionalColaboradores(): Colaborador[] {
  ...
  const empresas = [
    "DataLife Tecnologia Ltda",
    "Construção Civil ABC",
    "Indústria XYZ",
  ];
...
export const notificacoesMock: Notificacao[] = [
  {
    ...
    mensagem:
      'O EPI "Luvas de Proteção" do colaborador João Silva vence em 15 dias.',
    tipo: "vencimento",
  ...
  },
  {
    ...
    mensagem:
      'O item "Luvas de Proteção" está com estoque baixo (8 unidades restantes).',
    tipo: "estoque_baixo",
  ...
  },
  {
    ...
    mensagem:
      'O item "Máscara PFF2" está com estoque esgotado. Reposição urgente necessária.',
    tipo: "alerta",
  ...
  },
  {
    ...
    mensagem:
      "A ficha EPI do colaborador Maria Santos está vencida e precisa ser renovada.",
    tipo: "importante",
