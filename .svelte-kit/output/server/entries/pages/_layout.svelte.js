...
const TipoMovimentacao = {
  ...
  ESTORNO_SAIDA_DEVOLUCAO: "ESTORNO_SAIDA_DEVOLUCAO",
  // Estorno para SAIDA_DEVOLUCAO
...
const configurationStore = writable(null);
derived(
  configurationStore,
...
derived(
  ...
  () => Object.entries(TipoMovimentacao).map(([key, value]) => ({
    ...
    disabled: value.startsWith("ESTORNO_")
    // Estornos não são selecionáveis pelo usuário
  }))
);
derived(
  configurationStore,
...
function getTipoMovimentacaoLabel(tipo) {
  const mapping = {
    // Movimentações Diretas
...
function getStatusEntregaItemLabel(status) {
  const mapping = {
...
const CompanySelector = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="relative"><button type="button" class="${"rounded-sm flex items-center gap-2 px-3 py-2 w-60 border-0 focus:ring-0 focus:outline-none " + escape(getButtonClasses(), true)}"> ${validate_component(BuildingOutline, "BuildingOutline").$$render(
      $$result,
      {
      ...
      {},
      {}
    )}</button> ${validate_component(Dropdown, "Dropdown").$$render($$result, { placement: "bottom-start", class: "w-72" }, {}, {
      default: () => {
  ...
  return ` <header class="${"px-4 h-16 fixed left-0 right-0 top-0 z-50 border-b " + escape(headerClasses, true)}"><div class="flex items-center w-full h-full"> <button type="button" class="${"lg:hidden rounded-sm p-2 " + escape(buttonClasses, true)}">${validate_component(BarsOutline, "BarsOutline").$$render($$result, { class: "w-5 h-5" }, {}, {})}</button>  <div class="flex items-center" data-svelte-h="svelte-1yd55dk"><div class="flex items-center mr-3"><img src="${escape(base, true) + "/logo-icon.svg"}" alt="DataLife Logo" class="w-8 h-8 mr-2"> <img src="${escape(base, true) + "/logo-text.svg"}" alt="DataLife" class="h-5"></div></div>  <div class="hidden lg:flex items-center" style="margin-left: 108px;"><button type="button" class="${"flex items-center gap-2 p-2 rounded-sm " + escape(buttonClasses, true)}">${validate_component(GridOutline, "GridOutline").$$render($$result, { class: "w-4 h-4" }, {}, {})} <span class="${"text-base font-normal " + escape(
    ...
    default: () => {
      return `<div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700" data-svelte-h="svelte-hnufv1"><p class="text-sm text-gray-900 dark:text-white font-medium">Admin</p> <p class="text-xs text-gray-500 dark:text-gray-400">admin@datalife.com</p></div> ${validate_component(DropdownItem, "DropdownItem").$$render($$result, { class: "flex items-center gap-2 text-sm" }, {}, {
        ...
        default: () => {
          return `${$themeStore === "dark" ? `${validate_component(SunOutline, "SunOutline").$$render($$result, { class: "w-4 h-4" }, {}, {})}
              Tema Claro` : `${validate_component(MoonOutline, "MoonOutline").$$render($$result, { class: "w-4 h-4" }, {}, {})}
              Tema Escuro`}`;
        }
      })} ${validate_component(DropdownDivider, "DropdownDivider").$$render($$result, {}, {}, {})} ${validate_component(DropdownItem, "DropdownItem").$$render(
        $$result,
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })}  ${validate_component(NotificationToast, "NotificationToast").$$render($$result, {}, {}, {})}`;
});
export {
  Layout as default
};
