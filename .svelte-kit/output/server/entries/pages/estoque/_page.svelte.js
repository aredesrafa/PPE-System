        ...
        data: [
          {
            ...
            quantidade: 25,
            status: "disponivel",
            dataUltimaMovimentacao: (/* @__PURE__ */ new Date()).toISOString(),
...
function getStatusInfo(status) {
  ...
  switch (normalizedStatus) {
    ...
    case "quarentena":
      return { color: "orange", label: "Em Quarentena" };
...
const InventoryTablePresenter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.statusOptions === void 0 && $$bindings.statusOptions && statusOptions !== void 0) $$bindings.statusOptions(statusOptions);
  {
    {
