...
import { c as createUrlWithParams, a as api } from "../../../chunks/apiClient.js";
import { L as LoadingSpinner, E as ErrorDisplay, R as RefreshOutline, T as Table, a as TableHead, b as TableHeadCell, c as TableBody, d as TableBodyRow, e as TableBodyCell, f as Label, g as createPaginatedStore } from "../../../chunks/ErrorDisplay.js";
              ...
              {},
              {
                default: () => {
                  return `${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, {}, {}, {
                    ...
                    default: () => {
                      return `${epi.vidaUtilDias || epi.validadePadrao ? `<span class="text-sm">${escape(Math.round((epi.vidaUtilDias || epi.validadePadrao || 0) / 30))} meses
...
const EPIDetailDrawer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const categoriaOptions = [
    {
      value: "PROTECAO_CABECA",
      label: "Proteção da Cabeça",
      name: "Proteção da Cabeça"
    },
    {
      value: "PROTECAO_OLHOS_ROSTO",
      label: "Proteção dos Olhos e Rosto",
      name: "Proteção dos Olhos e Rosto"
    },
    {
      value: "PROTECAO_OUVIDOS",
      label: "Proteção Auditiva",
      name: "Proteção Auditiva"
    },
    {
      value: "PROTECAO_RESPIRATORIA",
      label: "Proteção Respiratória",
      name: "Proteção Respiratória"
    },
    {
      value: "PROTECAO_MAOS_BRACCOS",
      label: "Proteção das Mãos e Braços",
      name: "Proteção das Mãos e Braços"
    },
    {
      value: "PROTECAO_PES",
    ...
    {
      value: "PROTECAO_CLIMATICA",
      label: "Proteção Climática",
      name: "Proteção Climática"
    },
    {
      value: "ROUPA_APROXIMACAO",
      label: "Roupa de Aproximação",
      name: "Roupa de Aproximação"
    }
  ];
  const statusOptions = [
    {
